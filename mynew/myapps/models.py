...
class Nurse(models.Model):
    user = models.OneToOneField('myapps.profile', on_delete=models.CASCADE, related_name='nurse')
...
class Doctor(models.Model):
    ...
    user = models.OneToOneField('myapps.profile', on_delete=models.CASCADE, related_name='doctor')
    phone_number = models.CharField(max_length=15)
...
class Patient(models.Model):
    user = models.OneToOneField('myapps.profile', on_delete=models.CASCADE, related_name='patient')
